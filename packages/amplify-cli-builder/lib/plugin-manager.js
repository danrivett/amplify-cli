...
exports.removePluginPackage =
  ...
  exports.addExcludedPluginPackage =
  exports.addUserPluginPackage =
  exports.confirmAndScan =
  exports.createNewPlugin =
  exports.verifyPlugin =
  exports.scan =
  exports.getAllPluginNames =
  exports.getPluginsWithEventHandler =
  exports.getPluginsWithNameAndCommand =
  exports.getPluginsWithName =
  exports.getPluginPlatform =
    void 0;
...
const addPluginPackage = async (pluginPlatform, pluginDirPath) => {
  ...
  if (pluginVerificationResult.verified) {
    ...
    if (
      !(0, scan_plugin_platform_1.isUnderScanCoverageSync)(pluginPlatform, pluginDirPath) &&
