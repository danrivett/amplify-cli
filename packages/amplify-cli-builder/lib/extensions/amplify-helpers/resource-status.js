...
Object.defineProperty(exports, 'getResourceStatus', {
  enumerable: true,
  get: function () {
    return resource_status_data_1.getResourceStatus;
  },
});
Object.defineProperty(exports, 'getHashForResourceDir', {
  enumerable: true,
  get: function () {
    return resource_status_data_1.getHashForResourceDir;
  },
});
async function showStatusTable(tableViewFilter) {
  ...
  const {
    ...
    allResources,
    tagsUpdated,
  } = await (0, resource_status_data_1.getMultiCategoryStatus)(tableViewFilter);
  if (amplifyProjectInitStatus === get_cloud_init_status_1.CLOUD_INITIALIZED) {
    (0, resource_status_view_1.viewEnvInfo)();
  }
  (0, resource_status_view_1.viewSummaryTable)({
    resourcesToBeUpdated,
    resourcesToBeCreated,
    resourcesToBeDeleted,
    resourcesToBeSynced,
...
async function showResourceTable(category, resourceName, filteredResources) {
  ...
  const {
    ...
    tagsUpdated,
    rootStackUpdated,
  } = await (0, resource_status_data_1.getResourceStatus)(category, resourceName, undefined, filteredResources);
  if (amplifyProjectInitStatus === get_cloud_init_status_1.CLOUD_INITIALIZED) {
    (0, resource_status_view_1.viewEnvInfo)();
  }
  (0, resource_status_view_1.viewSummaryTable)({
