...
exports.removeDeploymentSecrets =
  exports.removeResourceParameters =
  exports.loadEnvResourceParameters =
  exports.saveEnvResourceParameters =
    void 0;
...
function getCurrentEnvName(context) {
  ...
  return (0, get_env_info_1.getEnvInfo)().envName;
}
  ...
  if (!isMigrationContext(context)) {
    ...
    if (hostedUIProviderCreds) {
      amplify_cli_core_1.stateManager.setDeploymentSecrets(
        (0, amplify_cli_core_1.mergeDeploymentSecrets)({
      ...
      amplify_cli_core_1.stateManager.setDeploymentSecrets(
        (0, amplify_cli_core_1.removeFromDeploymentSecrets)({
          currentDeploymentSecrets: deploymentSecrets,
          rootStackId,
          category,
          resource,
