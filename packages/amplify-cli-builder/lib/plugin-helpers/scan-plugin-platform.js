...
exports.isUnderScanCoverageSync =
  exports.normalizePluginDirectory =
  exports.getCorePluginVersion =
  exports.getCorePluginDirPath =
  exports.scanPluginPlatform =
    void 0;
...
async function scanPluginPlatform(pluginPlatform) {
  pluginPlatform = pluginPlatform || (0, access_plugins_file_1.readPluginsJsonFile)() || new plugin_platform_1.PluginPlatform();
  ...
  await (0, platform_health_check_1.checkPlatformHealth)(pluginPlatform);
  ...
  if (pluginVerificationResult.verified && pluginVerificationResult.manifest.name !== constants_1.constants.CORE) {
    ...
    if (!isPluginExcluded) {
      ...
      const pluginAlreadyAdded = pluginPlatform.plugins[manifest.name].some(item =>
        (0, compare_plugins_1.twoPluginsAreTheSame)(item, pluginInfo),
      );
