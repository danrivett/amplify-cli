...
is the directory that contains the Amplify CLI Core package.`);
  context.print.blue((0, scan_plugin_platform_1.normalizePluginDirectory)(constants_1.constants.ParentDirectory));
...
is the Amplify CLI Core package's local node_modules directory. `);
  context.print.blue((0, scan_plugin_platform_1.normalizePluginDirectory)(constants_1.constants.LocalNodeModules));
...
is the global node_modules directory.`);
  context.print.blue((0, scan_plugin_platform_1.normalizePluginDirectory)(constants_1.constants.GlobalNodeModules));
  context.print.info('');
}
