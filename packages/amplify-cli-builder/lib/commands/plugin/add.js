...
async function addExcludedPluginPackage(context, userSelection) {
  if (userSelection.length > 0) {
    if (userSelection.length === 1) {
      (0, plugin_manager_1.addExcludedPluginPackage)(context.pluginPlatform, userSelection[0]);
    } else {
      const options = new Array();
      ...
      (0, plugin_manager_1.addExcludedPluginPackage)(context.pluginPlatform, answer.selection);
    }
    await (0, plugin_manager_1.confirmAndScan)(context.pluginPlatform);
  }
}
