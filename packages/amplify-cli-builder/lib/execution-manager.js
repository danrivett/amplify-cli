...
exports.raiseEvent =
  exports.raisePostEnvAddEvent =
  exports.raiseIntenralOnlyPostEnvRemoveEvent =
  exports.isContainersEnabled =
...
async function executeCommand(context) {
  const pluginCandidates = (0, plugin_manager_1.getPluginsWithNameAndCommand)(
...
async function raiseIntenralOnlyPostEnvRemoveEvent(context, envName) {
  await raiseEvent(
    context,
    new amplify_event_1.AmplifyEventArgs(
      amplify_event_1.AmplifyEvent.InternalOnlyPostEnvRemove,
      new amplify_event_1.AmplifyInternalOnlyPostEnvRemoveEventData(envName),
    ),
  );
}
exports.raiseIntenralOnlyPostEnvRemoveEvent = raiseIntenralOnlyPostEnvRemoveEvent;
async function raisePostEnvAddEvent(context, prevEnvName, newEnvName) {
  await raiseEvent(
    context,
    new amplify_event_1.AmplifyEventArgs(
      amplify_event_1.AmplifyEvent.PostEnvAdd,
      new amplify_event_1.AmplifyPostEnvAddEventData(prevEnvName, newEnvName),
    ),
  );
}
