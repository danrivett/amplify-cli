  ...
  if (context.exeInfo.inputParams.amplify && context.exeInfo.inputParams.amplify.projectName) {
    ...
    if (!context.exeInfo.inputParams.yes) {
      const projectNameQuestion = {
        ...
        default: projectName,
        validate: input =>
          (0, project_name_validation_1.isProjectNameValid)(input) || 'Project name should be between 3 and 20 characters and alphanumeric',
      };
...
function checkEnvAddExec(context) {
